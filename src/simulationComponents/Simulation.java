...
public class Simulation {
	...
	public Simulation( int minCustomerTimeDifference, int maxCustomerTimeDifference, int minCustomerServiceTime, int maxCustomerServiceTime, int maxQueues, long simulationTime)
	{
		...
		timer = new Timer();
		timer.schedule(new Thread(minCustomerTimeDifference, maxCustomerTimeDifference, minCustomerServiceTime, maxCustomerServiceTime, maxQueues), 1000,10);
